#!/usr/bin/env python3
"""
Simple Sokogate scraper using requests and BeautifulSoup with SSL verification disabled
"""
...
logging.basicConfig(
    ...
    handlers=[
        logging.FileHandler('simple_scraper_no_ssl.log'),
...
def main():
    """Main function"""
    print("🕷️  Simple Sokogate Product Scraper (SSL Disabled)")
    print("=" * 60)
    ...
    if products:
        ...
        print(f"   - simple_scraper_no_ssl.log")
    else:
